...
export function exportToExcel(
  ...
  const rows: ExcelRow[] = landlords.map((landlord) => ({
    ...
    押金方式: translateDepositMethod(landlord.deposit as DepositMethod),
    电费: landlord.commonFees.electricity.price || "",
    水费: landlord.commonFees.water.price || "",
    网费: landlord.commonFees.internet || "",
    管理费: landlord.commonFees.management || "",
