...
export interface Landlord {
  ...
  // 公共费用标准
  depositMethod?: DepositMethod;      // 押金方式
  electricity?: number;               // 电费单价（元/度）
  water?: number;                     // 水费单价（元/吨）
  internet?: number;                  // 网费（元/月）
  management?: number;                // 管理费（元/月）
  otherFees?: string;                 // 其他费用（文本描述）
  
  // 关联房源
  properties: Property[];             // 房源列表
