...
- **离线访问**：首次加载后，无需网络即可使用应用
- **桌面安装**：可安装到桌面或手机主屏幕，像原生应用一样使用
- **自动更新**：部署新版本时自动更新 Service Worker
- **快速启动**：安装后启动速度更快，体验更流畅
- **跨平台**：支持 Chrome、Edge 等现代浏览器
...
如果您使用 Chrome 或 Edge 浏览器，可以将应用安装到桌面：

1. 点击工具栏中的 **「安装应用到桌面」** 按钮（📱 图标）
2. 在弹出的提示中点击「安装」
3. 应用将添加到您的桌面或应用列表
4. 安装后可离线使用，启动速度更快

> **提示**：安装按钮仅在支持 PWA 的浏览器中且应用未安装时显示。
...
| 📱 PWA      | vite-plugin-pwa        | 最新版       | 离线访问、应用安装    |
...
- [ ] 🏷️ 标签系统：自定义标签分类
- [ ] 🔍 智能搜索：全文搜索、模糊匹配
- [x] 📱 移动端优化：响应式布局、PWA 支持（已实现离线访问、添加到主屏幕）
- [ ] 🔔 提醒功能：待联系提醒、备份提醒
